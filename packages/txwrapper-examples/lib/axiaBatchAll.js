...
async function main() {
    ...
    const txMethods = transferArgs.map((args) => {
        const txInfo = txwrapper_axia_1.methods.balances.transferKeepAlive(args, {
    ...
    const unsigned = txwrapper_axia_1.methods.utility.batchAll({
        calls: txMethods,
    }, {
        address: alice.address,
        blockHash: blockHash,
...
//# sourceMappingURL=axiaBatchAll.js.map