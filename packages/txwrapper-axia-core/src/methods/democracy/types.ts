...
import { ArrayElementType } from '@axia-js/types/types';
 ...
 * conviction. This is useful for allychains, which vote on behalf of their 
participants and are free to choose their own way of splitting up the total
balance. The stake behind a allychain can e.g. be split e.g. 2/3 aye and
1/3 nay.
 */
