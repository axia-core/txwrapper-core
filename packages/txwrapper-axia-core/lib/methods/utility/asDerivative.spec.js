...
describe('utility::asDerivative', () => {
    it('should work', () => {
        const unsignedBalancesTransfer = (0, transferKeepAlive_1.transferKeepAlive)(test_helpers_1.TEST_METHOD_ARGS.balances.transferKeepAlive, txwrapper_core_1.TEST_BASE_TX_INFO, txwrapper_core_1.AXIA_25_TEST_OPTIONS);
        const unsigned = (0, asDerivative_1.asDerivative)({
            index: 1,
