...
describe('vesting::vestOther', () => {
    it('should work', () => {
        const unsigned = (0, vestOther_1.vestOther)(test_helpers_1.TEST_METHOD_ARGS.vesting.vestOther, txwrapper_core_1.TEST_BASE_TX_INFO, txwrapper_core_1.AXIA_25_TEST_OPTIONS);
