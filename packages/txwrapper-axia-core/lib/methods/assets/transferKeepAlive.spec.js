...
describe('assets:transferKeepAlive', () => {
    it('should work', () => {
        const unsigned = (0, transferKeepAlive_1.transferKeepAlive)(test_helpers_1.TEST_METHOD_ARGS.assets.transferKeepAlive, txwrapper_core_1.TEST_BASE_TX_INFO_V29, txwrapper_core_1.AXIA_29_TEST_OPTIONS);
