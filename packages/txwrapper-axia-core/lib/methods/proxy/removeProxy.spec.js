...
describe('proxy::removeProxy', () => {
    it('should work', () => {
        const unsigned = (0, removeProxy_1.removeProxy)(test_helpers_1.TEST_METHOD_ARGS.proxy.addProxy, txwrapper_core_1.TEST_BASE_TX_INFO, txwrapper_core_1.AXIA_25_TEST_OPTIONS);
