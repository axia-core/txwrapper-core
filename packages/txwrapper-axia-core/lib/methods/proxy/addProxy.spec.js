...
describe('proxy::addProxy', () => {
    it('should work', () => {
        const unsigned = (0, addProxy_1.addProxy)(test_helpers_1.TEST_METHOD_ARGS.proxy.addProxy, txwrapper_core_1.TEST_BASE_TX_INFO, txwrapper_core_1.AXIA_25_TEST_OPTIONS);
