...
describe('proxy::announce', () => {
    it('should work', () => {
        const unsigned = (0, announce_1.announce)(test_helpers_1.TEST_METHOD_ARGS.proxy.announce, txwrapper_core_1.TEST_BASE_TX_INFO, txwrapper_core_1.AXIA_25_TEST_OPTIONS);
