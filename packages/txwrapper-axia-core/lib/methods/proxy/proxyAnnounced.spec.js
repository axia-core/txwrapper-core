...
describe('proxy::proxyAnnounced', () => {
    it('should work', () => {
        const unsigned = (0, proxyAnnounced_1.proxyAnnounced)(test_helpers_1.TEST_METHOD_ARGS.proxy.proxyAnnounced, txwrapper_core_1.TEST_BASE_TX_INFO, txwrapper_core_1.AXIA_25_TEST_OPTIONS);
