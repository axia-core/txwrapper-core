...
describe('staking::nominate', () => {
    it('should work', () => {
        const unsigned = (0, nominate_1.nominate)(test_helpers_1.TEST_METHOD_ARGS.staking.nominate, txwrapper_core_1.TEST_BASE_TX_INFO, txwrapper_core_1.AXIA_25_TEST_OPTIONS);
